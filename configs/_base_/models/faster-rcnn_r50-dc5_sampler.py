    ...
    detector=dict(
        ...
        rpn_head=dict(
            ...
            anchor_generator=dict(
                ...
                scales=[4, 8, 16, 32],  # 这里加个2试试能不能提高小目标检测率？会增加计算量
                ratios=[0.5, 1.0, 2.0],
                strides=[16]),
            bbox_coder=dict(
        ...
        train_cfg=dict(
            rpn=dict(
                ...
                sampler=dict(
                    ...
                    num=256,
                    pos_fraction=0.5,
                    neg_pos_ub=5,  # libra从-1改为5
                    add_gt_as_proposals=False),
                allowed_border=-1,  # libra从0改为-1
                pos_weight=-1,
                debug=False),
            rpn_proposal=dict(
            ...
            rcnn=dict(
                assigner=dict(
                    ...
                    ignore_iof_thr=-1),
                sampler=dict(
                    type='CombinedSampler',  # libra论文中的采样
                    num=512,
                    pos_fraction=0.25,
