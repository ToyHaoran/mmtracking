...
custom_imports = dict(
    imports=['projects.diffusiondet'], allow_failed_imports=False)
...
model = dict(
    ...
    neck=dict(
        ...
        out_channels=256,
        num_outs=4),  # 这里输出4个尺度的特征图
    bbox_head=dict(
        type='DynamicDiffusionDetHead',
        num_classes=80,
        feat_channels=256,
        num_proposals=200,    # TODO 原来500导致内存溢出，改为200才能跑起来
        num_heads=6,
...
train_cfg = dict(type='IterBasedTrainLoop', max_iters=400,  val_interval=400)  # 原来450000
